...
.CODE
	...
	main  PROC
		...
		MOV BX, [ BP-12 ]
		PUSH BX; line no 9 : j loaded
		POP BX; line no 9 :  ; multiplication start of integer
		MOV CX, BX
		POP AX
		IMUL CX
		...
		POP BX; line no 18 : ; previously pushed value on stack is removed
		
		MOV BX, [ BP-22 ]
		PUSH BX; line no 19 : o loaded
		POP BX
		PUSH BX
		CALL PRINT_DECIMAL_INTEGER
		...
		POP BX; line no 21 : ; previously pushed value on stack is removed
		
		MOV BX, [ BP-24 ]
		PUSH BX; line no 22 : p loaded
		POP BX
		PUSH BX
		CALL PRINT_DECIMAL_INTEGER
		...
		POP BX; line no 24 : ; previously pushed value on stack is removed
		
		MOV BX, [ BP-24 ]
		PUSH BX; line no 25 : p loaded
		POP BX
		PUSH BX
		CALL PRINT_DECIMAL_INTEGER
		...
		POP BX; line no 30 : ; previously pushed value on stack is removed
		
		MOV BX, [ BP-14 ]
		PUSH BX; line no 31 : k loaded
		POP BX
		PUSH BX
		CALL PRINT_DECIMAL_INTEGER
